...
contract Solidice is VRFConsumerBase {
  ...
  bytes32 constant internal keyHash = 0x6c3699283bda56ad74f6b855546325b68d482e983852a7a82979cc4807b641f4;
  ...
  constructor() VRFConsumerBase(VFRC_address, LINK_address) public {
    ...
    /** !UPDATE
     * 
     * assign ETH/USD Kovan contract address to the aggregator variable.
     * more: https://docs.chain.link/docs/ethereum-addresses
     */
     
    ethUsd = AggregatorV3Interface(0x9326BFA02ADD2366b30bacB125260Af641031331);
  }
